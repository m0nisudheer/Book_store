...
public class fluidmec extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        pw.print("<h2 style=\"text-align:center;color:black;font-family:arial black;text-shadow:2px 1px #fed6e3\">List of Fluid Mechanics Books</h2>");
             
        //pw.print("<h2>List of C Programming Books...</h2>");
                
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\1.jpg' width='100' height='120' align='center'/></td>");
		pw.print("<td align='center'> Book: Fluid Mechanics Ninth Edition by Frank M.White<br> Author:Frank M.White <br> Publication:1964</td>");
		...
		pw.print("<td align='center'> <input type='checkbox' class='my-checkbox' name='items' value='1099'/></td> </tr>");
                ...
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\2.jpg' width='100' height='120' align='center'/></td>");
		pw.print("<td align='center'> Book:Fluid Mechanics by Dr.R.K.Bansal <br> Author:Dr.R.K.Bansal <br> Publication:1962</td>");
		...
		pw.print("<td align='center'> <input type='checkbox' class='my-checkbox' name='items' value='648'/></td> </tr>");
                ...
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\3.jpg' width='100' height='120' align='center'/></td>");
		pw.print("<td align='center'> Book:Fluid Mechanics And Machinery by R.Rudramoorthy <br> Author:R.Rudramoorthy <br> Publication:1881</td>");
		...
		pw.print("<td align='center'> <input type='checkbox' class='my-checkbox' name='items' value='1380'/></td> </tr>");
                ...
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\4.jpg' width='100' height='120' align='center'/></td>");
		...
		pw.print("<td align='center'> <input type='checkbox' class='my-checkbox' name='items' value='289'/></td> </tr>");
                ...
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\5.jpg' width='100' height='120' align='center'/></td>");
		pw.print("<td align='center'> Book:Fluid Mechanics by Yunus A Cengel <br> Author:Yunus A Cengel <br> Publication:1946</td>");
		...
		pw.print("<td align='center'> <input type='checkbox' class='my-checkbox' name='items' value='645'/></td> </tr>");
                ...
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\6.jpg' width='100' height='120' align='center'/></td>");
		pw.print("<td align='center'> Book:Fluid Mechanics by Er.R.K.Rajput<br> Author:Er.R.K.Rajput <br> Publication:1988</td>");
		...
		pw.print("<td align='center'> <input type='checkbox' class='my-checkbox' name='items' value='1200'/></td> </tr>");
                ...
                pw.print("<tr><td align='center'><img src='image\\fluidmec\\7.jpg' width='100' height='120' align='center'/></td>");
		pw.print("<td align='center'>Book:Engineering Fluid Mechanics by R.J.Grade<br> Author:R.J.Grade <br> Publication:1980</td>");
